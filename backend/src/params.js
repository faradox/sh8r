// Parameter defaults and sanitization, shared by live state and presets.
// Every value stored in server state goes through sanitizeValue, so clients
// can rely on well-formed values of the declared type.
